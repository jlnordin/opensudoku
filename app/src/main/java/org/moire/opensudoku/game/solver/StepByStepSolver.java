...
public class StepByStepSolver {
    ...
    static public AbstractTechnique getNextTechnique(Context context, SudokuGame game) {
        ...
        AbstractTechnique.TechniqueFactory[] techniques = {
                ...
                HiddenSubsetTechnique::createPair,
                FishTechnique::createXWing,
                FishTechnique::createSwordfish,
                NakedSubsetTechnique::createTriple,
                FishTechnique::createJellyfish,
                HiddenSubsetTechnique::createTriple,
                NakedSubsetTechnique::createQuadruple,
                HiddenSubsetTechnique::createQuadruple,
